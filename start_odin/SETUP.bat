...
mkdir M1\core       2>nul
mkdir M1\memory_pro  2>nul
mkdir M2\sense       2>nul
mkdir M2\vision      2>nul
mkdir P1\hunter      2>nul
mkdir P2\mobile      2>nul
...
python -c "import google.generativeai; print('  google-generativeai: OK')" 2>nul ||
